              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center" id="collapse">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="https://aadg-api-restaurante.herokuapp.com/pages/usuarios/registroUsuario.php">Registro</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark header" aria-label="Tenth navbar example">
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center" id="collapse">
                  <ul class="navbar-nav">
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="https://aadg-api-restaurante.herokuapp.com/pages/user/cartaPlatos.php">Carta</a>
                    </li>
                    <li class="nav-item">
            ...
            <body>
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center" id="collapse">
                  <ul class="navbar-nav">
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="https://aadg-api-restaurante.herokuapp.com/pages/platos/cartaPlatos.php">Carta</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="https://aadg-api-restaurante.herokuapp.com/pages/usuarios/mostrarUsuarios.php">Usuarios</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="https://aadg-api-restaurante.herokuapp.com/pages/ingredientes/mostrarIngrediente.php">Ingredientes</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="https://aadg-api-restaurante.herokuapp.com/pages/usuarios/perfilUsuario.php">Perfil</a>
                    </li>
